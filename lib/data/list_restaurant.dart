...
String restaurantListToJson(RestaurantResult data) => json.encode(data.toJson());
...
//
// List<Restaurant> parseLocalRestaurant(String? json) {
//   if (json == null) {
//     return [];
//   }
//
//   List parsed = jsonDecode(json)["restaurant"];
